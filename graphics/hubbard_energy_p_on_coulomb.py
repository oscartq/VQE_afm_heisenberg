...
# For each coulomb and number_p, search for the latest file and extract data from the last row
for i, coulomb in enumerate(coulomb_list):
    ...
    # Plot the graph with different markers and linestyles for each coulomb value
